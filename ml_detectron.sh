...
srun --export=all -n 1 singularity exec -B $projectDir:/workspace --nv $containerImage python3 pawsey/train_caps.py 10 4 && python3 pawsey/train_unet.py 10 4 
